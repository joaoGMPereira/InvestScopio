//
//  INVSTotalTimesViewController.swift
//  InvestScopio
//
...
protocol INVSTotalTimesViewControllerDelegate: class {
    func didChangeInterestRate(type: INVSInterestRateType, value: String)
}

protocol INVSTotalTimesViewControllerProtocol: class {
    func displayChangeType(type: INVSInterestRateType)
}

class INVSTotalTimesViewController: UIViewController {
    ...
    var delegate: INVSTotalTimesViewControllerDelegate?
    var type: INVSInterestRateType = .monthly
    var interactor: INVSTotalTimesInteractorProtocol?
  ...
  // MARK: Setup
    private func setup() {
        ...
        let interactor = INVSTotalTimesInteractor()
        let presenter = INVSTotalTimesPresenter()
...
extension INVSTotalTimesViewController: INVSCodeView {
    ...
    func setupAdditionalConfiguration() {
        ...
        interestRateTypeSegmentedControl.addTarget(self, action: #selector(INVSTotalTimesViewController.segmentedControlInterestRateTypeChanged(_:)), for: .valueChanged)
...
extension INVSTotalTimesViewController: INVSFloatingTextFieldDelegate {
...
extension INVSTotalTimesViewController: INVSTotalTimesViewControllerProtocol {
    func displayChangeType(type: INVSInterestRateType) {
        self.type = type
