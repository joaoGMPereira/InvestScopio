//
//  INVSSimulatedRescueChartView.swift
//  InvestScopio
//
...
class INVSSimulatedRescueChartView: UIView {
...
extension INVSSimulatedRescueChartView: INVSCodeView {
...
extension INVSSimulatedRescueChartView {
    ...
    func displayLeftAxys(withLastRescue lastRescue: Double) {
        ...
        leftAxis.axisMaximum = lastRescue + (lastRescue * 0.1)
...
extension INVSSimulatedRescueChartView: ChartViewDelegate {
