...
extension INVSFloatingTextFieldType {
    func setupTextField(withTextField textfield: INVSFloatingTextField,keyboardType: UIKeyboardType = .numberPad, andDelegate delegate: INVSFloatingTextFieldDelegate, valueTypeTextField: INVSFloatingTextFieldValueType, isRequired: Bool = false, hasInfoButton: Bool = false, leftButtons: [INVSKeyboardToolbarButton] = [.cancel], shouldShowKeyboard: Bool = true) {
            textfield.setup(placeholder: self.getTextFieldTitle(), typeTextField: self, valueTypeTextField: valueTypeTextField, keyboardType: keyboardType, required: isRequired, hasInfoButton: hasInfoButton, color: UIColor.INVSDefault(), leftButtons: leftButtons, shouldShowKeyboard: shouldShowKeyboard)
